...
- Diagnostic revision `52c815053e0942e1279bb52a4c49c7db39f209a1` corrected LED2 to latch receipt of `0x41`, because a valid `41 0A` probe necessarily leaves `0x0A` as the last byte. The revised build passed DRC with 0 errors/critical warnings and closed timing at WNS `3.356 ns`, WHS `0.159 ns`; utilization is 504 LUTs, 482 registers, 0 BRAM, 0 DSP.
- Revised bitstream SHA-256: `ac3d2952b688aae4f9983038abcd706e380ff171fd5b72de97dd7192e2dfc67f`. Programming passed at 2026-09-01 14:51 local time on exactly `887235230329A`/`xc7s50_0`, startup status HIGH.
